...
void pictest_it(const Size & size)
{
	char key = 27;

	Scalar trained(0, 255, 0);
	Mat img, draw;
	Ptr<SVM> svm;
	...
	svm = StatModel::load<SVM>("d:\\opencvtest\\my_detector3.yml");
...
void test_it(const Size & size)
{
	...
	// Load the trained SVM.
	svm = StatModel::load<SVM>("d:\\opencvtest\\my_people_detector.yml");
	// Set the trained svm to my_hog
	vector< float > hog_detector;
	get_svm_detector(svm, hog_detector);
	my_hog.setSVMDetector(hog_detector);
...
int main(int argc, char** argv)
{
	...
	vector< int > labels;
	string pos_dir = parser.get<string>("pd");		//"d:\\opencvtest\\posyunjiao\\";		//parser.get<string>("pd");
	string pos = parser.get<string>("p");			//"pos.txt";		//	parser.get<string>("p");
	string neg_dir = parser.get<string>("nd");		//"d:\\opencvtest\\neg\\";		// parser.get<string>("nd");
	string neg = parser.get<string>("n");		//"neg.txt";	//parser.get<string>("n");
